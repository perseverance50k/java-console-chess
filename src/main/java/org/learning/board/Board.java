...
public class Board {
    ...
    public void setupDefaultPiecePositions() {
        ...
        for (File file : File.values()) {
            Coordinates whitePawnCoordinates = new Coordinates(file, 2);
            Coordinates blackPawnCoordinates = new Coordinates(file, 7);
            setPiece(whitePawnCoordinates, new Pawn(Color.WHITE, whitePawnCoordinates));
            setPiece(blackPawnCoordinates, new Pawn(Color.BLACK, blackPawnCoordinates));
        }
